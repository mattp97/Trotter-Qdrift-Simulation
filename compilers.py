...
class CompositeSim:
    ...
    def set_initial_state(self, state):
        '''
        Function to set the initial state of the simulator. Accepts state vectors (to be converted to density matrix pure states if 
        `use_density_matrices=True`), or takes density matrices as input. Only accepts numpy arrays and does not check if state is a valid quantum state.
        '''
